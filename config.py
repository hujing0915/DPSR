...
parser.add_argument('--loss_att', type=float, default=0.8, help='the number of att_weight')
parser.add_argument('--GA_weight', type=float, default=0.8, help='weight on the GA loss')
parser.add_argument('--SD_weight', type=float, default=0.8, help='weight on the SD loss')
parser.add_argument('--NI_weight', type=float, default=0.8, help='weight on the NI loss')
parser.add_argument('--head_number', type=int, default=1, help='the number of the head')
