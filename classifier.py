...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5, _nepoch=20, _batch_size=100, netFR=None, dec_size=4096, dec_hidden_size=4096,  netGA=None, netSD=None, netSC=None):
        ...
        if self.netFR:
            ...
            self.input_dim = self.input_dim + dec_size * 2
            # self.input_dim = self.input_dim + dec_size * 3
    ...
    def compute_fear_out(self, test_X, new_size):
        ...
        for i in range(0, ntest, self.batch_size):
            ...
            mus, _, _, _, _, feat = self.netFR(inputX)
            means, _, _ = self.netSD(inputX)
