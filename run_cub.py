...
import os
os.system('''OMP_NUM_THREADS=64  python train_free.py --gammaD 1 --gammaG 1 \
...
--nclass_all 200 --nclass_seen 150 --batch_size 64 --nz 1024 --latent_size 1024 --attSize 1024 --resSize 768  \
